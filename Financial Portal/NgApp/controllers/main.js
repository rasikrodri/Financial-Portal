...
angular
    .module('app')
    .controller('appCtrl', appCtrl, ['authService']);

function appCtrl($http, $timeout, $scope, $state, authService, sharedDataSvc, sweetAlert) {
    

    $scope.User = authService.authentication;//For checkig for updates
